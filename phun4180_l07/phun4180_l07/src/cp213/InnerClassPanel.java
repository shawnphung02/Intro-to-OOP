...
public class InnerClassPanel extends JPanel {
	...
	public void itemStateChanged(final ItemEvent e) {
	    ...
	    final String str = src.getText();
	    
	    if (e.getStateChange() == ItemEvent.SELECTED) {
	    	// Update when new checkbox is chosen
	    	InnerClassPanel.this.checkBoxesSelected.add(str);
	    	InnerClassPanel.this.label.setText(checkBoxesSelected.toString());
	    	System.out.println(checkBoxesSelected.toString());
	    } else if (e.getStateChange() == ItemEvent.DESELECTED) {
	    	// Update when new checkbox is deselected
	    	InnerClassPanel.this.checkBoxesSelected.remove(str);
	    	InnerClassPanel.this.label.setText(checkBoxesSelected.toString());
	    	System.out.println(checkBoxesSelected.toString());
	    }
	}
	...
	@Override
	public void actionPerformed(final ActionEvent e) {
		// Update when radio button is clicked
	    final JRadioButton src = (JRadioButton) e.getSource();
	    InnerClassPanel.this.radioButtonSet = src.getText();
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    // Update when slider bar is changed
	    if (!src.getValueIsAdjusting()) {
		InnerClassPanel.this.sliderSet = src.getValue();
	...
	@Override
	public void stateChanged(final ChangeEvent e) {
		// Update when spinner is changed
	    final JSpinner src = (JSpinner) e.getSource();
	    InnerClassPanel.this.spinnerSet = (String) src.getValue();
	...
	@Override
	public void actionPerformed(final ActionEvent e) {
		// Update when text field is changed
	    final JTextField src = (JTextField) e.getSource();
	    InnerClassPanel.this.textEntry = src.getText();
